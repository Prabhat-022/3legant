    ...
    <>
      <div className="">
        ...
        <div className="border flex">
          ...
          <div className="bg-[#f1f1f1] w-full   p-8 h-[100vh]">
                ...
                <div className="">
                  ...
                  <div className="flex justify-between gap-2 w-full mt-4 mb-2">
                    <div className="flex items-center ">
                      ...
                      <input type="text" name="price" value={product.price} onChange={handleChange} className=" placeholder:text-xl placeholder:font-bold  placeholder:text-black bg-transparent outline-none border-black px-2 " placeholder="Add Price " />
                    </div>
